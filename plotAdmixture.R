...
## hard coded
opt$prefix= '/Users/pmonsieurs/programming/plasmodium_pvgenomes/results/admixture/PvP01_v1.filtered.core.coverage_filter_gtmissing.maf0.005.snps.ldpruned.filtered'
opt$infofile = '/Users/pmonsieurs/programming/plasmodium_pvgenomes/results/admixture/metadata_test.csv'
opt$maxK = 21
opt$minK = 20
opt$populations = c("WAS","Una","LAM","AFR","ESEA","OCE","MSEA")
...
tiff(file=paste0(opt$outPrefix,".tiff"),width = 2000, height = 1200,res=200)
 ...
 bp<-barplot(t(as.matrix(tbl[[1]][order(labels$n),])), col=getPalette(minK),xaxt="n", border=NA,ylab=paste0("K=",minK),yaxt="n",space=spaces)
